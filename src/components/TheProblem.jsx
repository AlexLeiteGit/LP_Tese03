  ...
  return (
    <section id="o-problema" className="py-24 px-6 bg-bg-dark relative overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <h2 className="font-display text-gold text-section mb-6 tracking-wide">O Problema Invisível</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {product.dores.map((dor, idx) => (
            <motion.div
              ...
              className="bg-transparent p-8 rounded-sm border border-white/10 hover:border-gold/50 transition-colors duration-500 flex gap-6 group"
            >
              <span className="text-4xl">{dor.emoji}</span>
              <div>
                <h3 className="font-display text-white group-hover:text-gold transition-colors duration-500 text-2xl mb-3">{dor.titulo}</h3>
