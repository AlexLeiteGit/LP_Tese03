    ...
    <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 overflow-hidden relative">
      ...
      <div className="container mx-auto max-w-5xl text-center">
        <motion.div
          ...
          className="inline-block bg-gold/10 border border-gold/30 px-5 py-2 rounded-sm mb-10"
        >
        ...
        <motion.h1
          ...
          className="font-display text-white text-[clamp(2.5rem,6vw,5.5rem)] mb-8 leading-[1.05] tracking-tight"
        >
          {product.headline}
        </motion.h1>
        ...
        <motion.p
          ...
          className="font-body text-muted text-lg lg:text-2xl font-light max-w-3xl mx-auto mb-12 leading-relaxed"
        >
          {product.subheadline}
        </motion.p>
        ...
        >
          ...
          >
            ...
            <span className="text-xl relative z-10">Verificar meu direito agora</span>
          </a>
        </motion.div>
